// api/[...route].js
// Catch-all API for Vercel. Handles /api/health, /api/patients, etc.
// Uses Neon Postgres via DATABASE_URL (set in Vercel Project → Settings → Env Vars)
...
// Build a clean path like "/patients" from the catch-all "route" param
